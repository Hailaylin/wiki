...
## HR术语
**HC**（Headcount）俗称人头，稍微专业点讲就是**这家公司打算招的人数**

**offer** 则是你被录用的时候收到的通知书，一般以邮件的形式发放

**HR**，负责人力资源，简单来说，就是主要负责招聘，和你入职到正式工作的相关事情。
...
互联网：测试工程师、视觉工程师、产品经理、运维（外包）7000（黑马）修网，工资时间凌晨更新、后端、前端。
...
企业级开发项目1个就是1年工作经验，一个核心的项目产出

一个人生的转折点，可以到处问，脸皮厚一点就可以了。
不同部门跨不行。